...
void statisztika(int szamok[], int* maxPozitiv, int* maxNegativ) {
    int legnagyobbPlusz = 0;
    int legnagyobbNegativ = 0;
    int szamP = 0, szamN = 0;
    int i;

    for (i = 0; szamok[i] != 0; i++) {
        if (szamok[i] > 0 && szamok[i] > legnagyobbPlusz) {
            legnagyobbPlusz = szamok[i];
            *maxPozitiv = legnagyobbPlusz;
            szamP++;
        }
        if (szamok[i] < 0 && szamok[i] > *maxNegativ) {
            legnagyobbNegativ = szamok[i];
            *maxNegativ = legnagyobbNegativ;
            szamN++;
        }
    }
    
    if (szamP == 0) {
        *maxPozitiv = szamok[i + 1];
    }
    if (szamN == 0) {
        *maxNegativ = szamok[i + 1];
    }
}
/***********************************************************************
************************************************************************
