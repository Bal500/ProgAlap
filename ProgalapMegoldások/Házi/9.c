...
char* sakktabla(char tabla[8][8], int* utniKepesBastyak) {
    ...
    for (int i = 0; i < count; i++) {
        for (int j = 0; j < count; j++) {
            if (i == row && j == column && tabla[i][j] == 'B') {
                bastya++;
            }

            if (i == 0 && j == 0 && tabla[i][j] == 'K') {
                if (i == 0 && j == 1 && tabla[i][j] == 'B' || i == 1  && j == 0 && tabla[i][j] == 'B' || i == 1 && j == 1 && tabla[i][j] == 'B') {
                    bastya++;
                }
            }
            
            if (i == 0 && j == count - 1 && tabla[i][j] == 'K') {
                if (i == 0 && j == count - 2 && tabla[i][j] == 'B' || i == 1  && j == count - 1 && tabla[i][j] == 'B' || i == 1 && j == count - 2 && tabla[i][j] == 'B') {
                    bastya++;
                }
            }
            
            if (i == count - 1 && j == 0 && tabla[i][j] == 'K') {
                if (i == count - 2 && j == 0 && tabla[i][j] == 'B' || i == count - 1  && j == 1 && tabla[i][j] == 'B' || i == count - 2 && j == 1 && tabla[i][j] == 'B') {
                    bastya++;
                }
            }

            if (i == count - 1 && j == count - 1 && tabla[i][j] == 'K') {
                if (i == count - 2 && j == count - 1 && tabla[i][j] == 'B' || i == count - 1 && j == count - 2 && tabla[i][j] == 'B' || i == count - 2 && j == count - 2 && tabla[i][j] == 'B') {
                    bastya++;
                }
            }

            if (i > 0 && j == 0 && i < count - 1 && tabla[i][j] == 'K') {
                if (tabla[i - 1][j] == 'B' || tabla[i - 1][j + 1] == 'B' || tabla[i][j + 1] == 'B' || tabla[i + 1][j + 1] == 'B' || tabla[i + 1][j] == 'B') {
                    bastya++;
                }
            }
            
            if (i > 0 && j == count -1 && i < count - 1 && tabla[i][j] == 'K') {
                if (tabla[i - 1][j] == 'B' || tabla[i - 1][j - 1] == 'B' || tabla[i][j - 1] == 'B' || tabla[i + 1][j - 1] == 'B' || tabla[i + 1][j] == 'B') {
                    bastya++;
                }
            }

            if (i > 0 && i < count - 1 && j > 0 && j < count - 1 && tabla[i][j] == 'K') {
                if (tabla[i - 1][j - 1] == 'B' || tabla[i - 1][j] == 'B' || tabla[i - 1][j + 1] == 'B' || tabla[i][j - 1] == 'B' || tabla[i][j + 1] == 'B' || tabla[i + 1][j - 1] == 'B' || tabla[i + 1][j] == 'B' || tabla[i + 1][j + 1] == 'B') {
                    bastya++;
                }
